      ...
      return function (m) {
          ...
          if (m instanceof Data_Abc.Chord) {
              ...
              if ($90.value0 instanceof Data_Either.Right && $90.value1 instanceof Data_Either.Right) {
                  return new Data_Either.Right(new Data_Tuple.Tuple(new VexTab_Abc_VexScore.VChord($90.value1.value0, $90.value0.value0.value0), ctx));
              };
          ...
          if (m instanceof Data_Abc.BrokenRhythmPair) {
              ...
              if ($108.value0 instanceof Data_Either.Right && $108.value1 instanceof Data_Either.Right) {
                  return new Data_Either.Right(new Data_Tuple.Tuple(new VexTab_Abc_VexScore.VNotePair($108.value0.value0.value0, $108.value1.value0.value0), $108.value1.value0.value1));
              };
